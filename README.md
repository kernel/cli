...
- `kernel proxies create` - Create a new proxy configuration
  ...
  - `--ca-bundle <path>` - Path to a PEM file containing one or more concatenated CA certificates (custom TLS-terminating proxies)
...
# Create a custom TLS-terminating proxy; one file may contain multiple concatenated CA certificates
