...
const DEFAULT_OPTIONS: Required<Omit<SessionOptions, 'invocationId'>> & { invocationId?: string } = {
  stealth: true,
  timeoutSeconds: 300,
  recordReplay: false,
...
export class KernelBrowserSession {
  ...
  private options: Required<Omit<SessionOptions, 'invocationId'>> & { invocationId?: string };
