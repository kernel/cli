...
# Another example
pnpm exec tsx index.ts "Go to https://github.com/trending and list the top 5 trending repositories"
```
...
pnpm exec tsx index.ts "Go to https://news.ycombinator.com and tell me the top 3 stories"
