import type { ToolResult, BetaToolResultBlock, BetaTextBlock, BetaImageBlock } from '../types';

export function makeApiToolResult(result: ToolResult, toolUseId: string): BetaToolResultBlock {
