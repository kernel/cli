...
import type { ActionParams, BaseAnthropicTool, ToolResult } from './types';
import { Action, ToolError } from './types';
...
export class ComputerTool implements BaseAnthropicTool {
  ...
  private readonly keyboardActions = new Set([Action.KEY, Action.TYPE, Action.HOLD_KEY]);

  private readonly systemActions = new Set([Action.SCREENSHOT, Action.CURSOR_POSITION, Action.SCROLL, Action.WAIT]);
